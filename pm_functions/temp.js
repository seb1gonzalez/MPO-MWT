   ...
   //Texas
    fetch('./results.json')
        ...
        .then(function (myJson) {
            console.log("pm18__1");
            //sizeT.push(myJson["PMS_18_19_tx"]["texasDataLength"][0]);
        //    console.log(sizeT);
             let counter = 90858;
...
var totalFatalities = {
    Driving: 0, drivingDeathRate: 0, totalCarCrashes: 0
}
...
function pm18_pm19_Data_Texas(){ 
    //Filter Info
    if(guardian == 0){
    for(let x = 0; x < 116120; x++){ //El paso: 90858 *** total: 116120
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// Pm19, store cordinates and the info of that point
         if((dateT[x].charAt(dateT[x].length-1)) == "3"  &&  classA_T[x] != 0 && latT[x]!=0 && longT[x] !=0) { 
            ...
            //driving_Cordinates_Injuries
                ...
                //driving_Cordinates_Fatalities.classO[pm19D] = classO_T[x];
    ...
    console.log(driving_Cordinates_Injuries);
    
    /*Ratio of 
            driving fatalities*/
    var numOfInjuries = Texas2013Info.Driving_ClassA + Texas2014Info.Driving_ClassA + Texas2015Info.Driving_ClassA + Texas2016Info.Driving_ClassA + Texas2017Info.Driving_ClassA +
                        Texas2013Info.Driving_ClassB + Texas2014Info.Driving_ClassB + Texas2015Info.Driving_ClassB + Texas2016Info.Driving_ClassB + Texas2017Info.Driving_ClassB +
                        Texas2013Info.Driving_ClassC + Texas2014Info.Driving_ClassC + Texas2015Info.Driving_ClassC + Texas2016Info.Driving_ClassC + Texas2017Info.Driving_ClassC +
                        Texas2013Info.Driving_ClassO + Texas2014Info.Driving_ClassO + Texas2015Info.Driving_ClassO + Texas2016Info.Driving_ClassO + Texas2017Info.Driving_ClassO;
                        
    totalFatalities.drivingDeathRate =  (totalFatalities.Driving)/(numOfInjuries);
    totalFatalities.totalCarCrashes = totalFatalities.Driving + numOfInjuries;
